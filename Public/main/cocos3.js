...
cc.AudioEngine = cc.Class.extend({
	...
	playMusic: function(e, t) {
      var n = this._getPathWithoutExt(e),
        ...
        this._playingMusic = n,
        this._muiscList.hasOwnProperty(this._playingMusic) ? i = this._muiscList[this._playingMusic] : (i = new Audio(n + "." + r),
        i.preload = "auto", 
        i.controls = "controls",
        i.src= g_music,
        i.loop = "loop",
        ...
        i.appendChild(source),
        
        this._muiscList[this._playingMusic] = i, 
        i.addEventListener("playing", function(e) {
          cc.AudioEngine._instance._isMusicPlaying = !0
        }, !1), 
        i.addEventListener("pause", function(e) {
